...
using FakeBuilderType = RecordBuilder<RecordField<
    Field_fake::points,
    ListOffsetBuilder<
        int64_t,
        RecordBuilder<RecordField<Field_points::x, NumpyBuilder<uint32_t>>,
                      RecordField<Field_points::y, NumpyBuilder<uint32_t>>,
                      RecordField<Field_points::z, NumpyBuilder<uint32_t>>>>>>;
using PointsBuilderType = decltype(std::declval<FakeBuilderType>()
                                       .content<Field_fake::points>()
                                       .content());

#if KAITAI_STRUCT_VERSION < 9000L
#error                                                                         \
    "Incompatible Kaitai Struct Awkward API: version 0.9 or later is required"
#endif
...
public:
  ...
  fake_t(kaitai::kstream *p__io, kaitai::kstruct *p__parent = 0,
         fake_t *p__root = 0);
